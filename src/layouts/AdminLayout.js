            ...
            <div className="w-full">
                ...
                <div className="p-4 flex items-center justify-between">
                    <div className="flex space-x-2 items-center">
                        <button 
                            className={`p-1.5 rounded-lg transition-all hover:bg-gray-100 dark:hover:bg-gray-700 ${isMenu ? "" : ""}`}
                            onClick={() => { setIsMenu(!isMenu) }}
                        >
                            <svg className={`w-5 h-5 fill-current transition-all ${isMenu ? "" : ""}`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex space-x-2 items-center">
                        ...
                        >
                            <svg className={`w-5 h-5 fill-current transition-all ${isSettings ? "" : ""}`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
